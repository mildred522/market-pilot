  ...
  return (
    <main className="control-shell">
      <aside className="control-rail">
        ...
        <nav aria-label="控制台导航"><a className="is-active" href="#overview">工作台</a><a href="/pre-open">开店前分析</a><a href="/pre-open#location">商圈与选址</a><a href="/operating">经营诊断</a><a href="#integrations">集成配置</a></nav>
      ...
      <div className="control-main">
        ...
        <section className="flow-section" aria-labelledby="flow-title">
          ...
          <div className="flow-lanes">
            <article className="flow-lane flow-lane-pre"><div className="flow-index">01</div><div className="flow-copy"><span>开店前 · {counts.pre_open_projects} 个项目</span><h3>先判断值不值得做，再决定在哪里做</h3><p>从资金结构与保本线开始，用真实周边 POI 校验竞争压力，形成开店决策依据。</p><div className="flow-steps"><a href="/pre-open"><b>项目测算</b><small>预算、租金、回本压力</small></a><a href="/pre-open#location"><b>商圈选址</b><small>竞品、需求与候选点</small></a></div></div><a className="flow-enter" href="/pre-open">开始评估 <span>↗</span></a></article>
            <article className="flow-lane flow-lane-operating"><div className="flow-index">02</div><div className="flow-copy"><span>开店后 · {counts.operating_projects} 个项目</span><h3>让数据说明问题，让 Agent 推进行动</h3><p>汇总订单、菜品、渠道和评论，定位利润流失环节并生成有证据的经营动作。</p><div className="flow-steps"><a href="/operating"><b>上传数据</b><small>订单、菜单与评价样本</small></a><a href="/operating"><b>Agent 诊断</b><small>归因、证据与行动清单</small></a></div></div><a className="flow-enter" href="/operating">进入诊断 <span>↗</span></a></article>
          </div>
        </section>
